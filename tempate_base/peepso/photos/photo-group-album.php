	...
	<div class="ps-album">
		...
		<div class="ps-album__header">
			<div class="ps-album__title">
				<i class="gcis gci-images"></i><?php echo sprintf('%s %s', $the_album->pho_album_name, __('Album', 'matebook')); ?>
			</div>

			<div class="ps-album__actions">
				<a class="ps-btn ps-btn--sm" href="<?php echo esc_url($photos_url); ?>"><i class="gcis gci-angle-left"></i><span><?php echo esc_html__('Back to Photos', 'matebook'); ?></span></a>
			</div>
		</div>
		...
		<div class="ps-album__filters">
			<div class="ps-album__list-view">
				<div class="ps-btn__group">
					<a href="#" class="ps-theme-btn--app ps-btn--cp ps-tip ps-tip--arrow ps-js-photos-viewmode" data-mode="small" aria-label="<?php echo esc_html__('Small thumbnails', 'matebook');?>"><i class="gcis gci-th"></i></a>
					<a href="#" class="ps-theme-btn--app ps-btn--cp ps-tip ps-tip--arrow ps-js-photos-viewmode" data-mode="large" aria-label="<?php echo esc_html__('Large thumbnails', 'matebook');?>"><i class="gcis gci-th-large"></i></a>
				</div>
			</div>
		...
		<div class="ps-scroll ps-js-photos-triggerscroll ps-js-photos-triggerscroll--<?php echo  apply_filters('peepso_user_profile_id', 0); ?>">
			<img class="post-ajax-loader ps-js-photos-loading" src="<?php echo PeepSo::get_asset('images/ajax-loader.gif'); ?>" alt="<?php esc_attr_e('Loading', 'matebook') ?>" style="display:none" />
		</div>
		<div class="mb-20"></div>
	</div>
	<?php } ?>
