        ...
        <div class="advert-item-inner">
			...
			<div class="advert-img">
		        <?php if($image_id): ?>
					...
					<img src="<?php echo esc_url( adverts_get_main_image( get_the_ID() ) ) ?>" class="advert-item-grow" title="<?php echo esc_attr($image->post_excerpt) ?>" alt="<?php echo esc_attr($image->post_content) ?>" />
		        <?php endif; ?>
			</div>
